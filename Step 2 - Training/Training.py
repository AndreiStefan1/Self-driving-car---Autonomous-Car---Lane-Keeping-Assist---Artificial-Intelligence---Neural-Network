...
path = 'DataCollected' #'C:\\Users\\Steff\\NeuralNetworkProject\\DataCollected'
print('path',path)
...
print('Sample Training Image Path:', xTrain[0])  # Print a sample training image path
print('Sample Validation Image Path:', xVal[0])  # Print a sample validation image path
